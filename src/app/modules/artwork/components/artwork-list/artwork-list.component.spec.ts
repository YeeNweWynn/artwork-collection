...
describe('ArtworkListComponent', () => {
  ...
  describe('component load', () => {
    it('should isLoading to be false', () => {
      expect(component.isLoading).toBeFalse();
    });
  });

  describe('ngOnInit()', () => {
    it('should get artwork list being called', fakeAsync(() => {
      //given
      spyOn(component, 'getArtWorks').and.returnValue();
  ...
  describe('onFilterChangesListner()', () => {
    it('should onFilterChangesListner being called', fakeAsync(() => {
      //given
      spyOn(component, 'getArtWorks').and.returnValue();
      spyOn(component, 'onFilterChangesListner').and.returnValue();

      //when
      fixture.detectChanges();

      //then
      expect(component.onFilterChangesListner).toHaveBeenCalled();

    }));
  });

  describe('getArtWorks()', () => {
    it('should getArtWorks http request being called', fakeAsync(()=>{
      //Given
      spyOn(artworkService, 'getArtWorks').and.returnValue(observableOf({
        "preference": null,
        "pagination": {
          "total": 116178,
          "limit": 8,
      ...
      //then
      expect(artworkService.getArtWorks).toHaveBeenCalled();
